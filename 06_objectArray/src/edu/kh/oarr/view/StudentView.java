...
public class StudentView {
	...
	/**
	 * 학생 추가 화면 학번, 이름, 성별을 입력 받아 StudentService의 students 배열에 추가
	 */
	...
	private void selectName() {
		...
		if (std == null)
			System.out.println("같은 이름의 학생이 존재X");
		else {
			System.out.println("학번 : " + std.getStudentNumber());
	...
	private void updateStudent() {
		...
		// HTML, CSS, JS, Java 점수 입력받아 바로 std에 세팅
	...
	/**
	 * 선택한 학생의 점수 조회 (각각의 점수, 합계, 평균) 1) 인덱스를 입력 받아 해당 학생이 존재하는지 확인
	 * 
	...
	private void selectScore() {
		...
		String scoreInfo = service.selectScore(index);
