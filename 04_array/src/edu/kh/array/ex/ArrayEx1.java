...
public class ArrayEx1 {
	...
	public void method2() {
		...
		for(int i=0 ; i<arr.length ; i++) { // i = 0, 1, 2, 3
			...
			arr[i] = sc.nextInt(); // i번째 인덱스 요소에 입력값을 대입
					}
		// 해당 구문 수행 전 break point를 생성해서 멈추게 함
...
//		for(int i = 3 ; i>=0 ; i--) {
	...
	public void method4() {
		...
		System.out.println(randoms); // 암호화된 주소가 출력
